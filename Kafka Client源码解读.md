...
![image-20240611193148977](Kafka Client源码解读.assets/image-20240611193148977.png)
...
KafkaProducer(ProducerConfig config,
    ...
    try {
        ...
        // 缓存大小 生产者最大内存中缓存的未发送到server的消息大小 默认是32M
...
![image-20240612004438908](Kafka Client源码解读.assets/image-20240612004438908.png)
...
![image-20240612072238105](Kafka Client源码解读.assets/image-20240612072238105.png)
...
![image-20240612080053697](Kafka Client源码解读.assets/image-20240612080053697.png)

![image-20240612080105922](Kafka Client源码解读.assets/image-20240612080105922.png)

要使用Selector，得向Selector注册Channel，然后调用它的select()方法。这个方法会一直阻塞到某个注册的通道有事件就绪。一旦这个方法返回，线程就可以处理这些事件，事件的例子有如新连接进来，数据接收等。

![image-20240612080144853](Kafka Client源码解读.assets/image-20240612080144853.png)
...
![image-20240612110419977](Kafka Client源码解读.assets/image-20240612110419977.png)

RoundRobin： 通过循环把主题分配给消费者

![image-20240612120640995](Kafka Client源码解读.assets/image-20240612120640995.png)

Sticky 粘性分区： 初始分区和 RoundRobin一致，每一次分配变更，相对做最少的变动

初始化分区

![image-20240612110442708](Kafka Client源码解读.assets/image-20240612110442708.png)

消费者这时候C1下线了

**如果是RoundRobin**

![image-20240612110459343](Kafka Client源码解读.assets/image-20240612110459343.png)
...
![image-20240612110515912](Kafka Client源码解读.assets/image-20240612110515912.png)
